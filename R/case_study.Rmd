...
This step-by-step tutorial is a supplement to our paper submitted to [Nature Ecology and Evolution](https://www.nature.com/natecolevol/).
...
First we load the dataset provided by Risely et al. (2008) @risely2018migratory, who meta-analysed  41 studies examining how both infection status and infection intensity were related to changes in body stores, refuelling rates, movement capacity, phenology and survival in migratory hosts across taxa.

For simplicity, we will only use the subset measuring infection status to show the illustration.
